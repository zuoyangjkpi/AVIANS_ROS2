...
echo "   - BASE_TRACKING_ANGULAR_VELOCITY: $(python3 -c "from src.drone_nmpc_tracker.drone_nmpc_tracker.config import nmpc_config; print(nmpc_config.BASE_TRACKING_ANGULAR_VELOCITY)")"
...
echo "=================================="
echo "1. 进一步降低BASE_TRACKING_ANGULAR_VELOCITY（如0.05）"
